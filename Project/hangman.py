...
def hangmann(letter, word, mistakes, theguess):  # פונקציה שאמורה לעשות את הבדיקה והוספה עד שאתה מצליח לגלות את כל האות, לספור טעויות וכו'
...
while word != theprint:
    ...
    theprint, mistakes = hangmann(letter, word, mistakes, theprint)
    if theprint == "False":
        print("K.O. U DEAD.")
